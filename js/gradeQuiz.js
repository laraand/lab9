$(document).ready(function(){
    ...
    $("form").submit(function(event) {
        ...
        $("#question1-feedback").append("The answer is <stron>1994</strong>");
        ...
        $("#question2-feedback").append("The answer is <stron>Monte Rey</strong>");
        ...
        $("#question3-feedback").append("The answer is <stron>Peter P. Smith</strong>");
        ...
        $("#question4-feedback").append("The answer is <stron>Seaside</strong>");
